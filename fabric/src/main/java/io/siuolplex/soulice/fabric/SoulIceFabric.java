...
public class SoulIceFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        NetherBiomes.addNetherBiome(ResourceKey.create(Registries.BIOME, new ResourceLocation("soul_ice", "soul_husk")), Climate.parameters(-0.4f, -0.6f, 0f, 0f, 0f, 0f, 0f));

        LootTableEvents.MODIFY.register(((resourceManager, lootManager, id, tableBuilder, source) -> {
            if (source.isBuiltin() && new ResourceLocation("minecraft", "entities/evoker").equals(id)) {
