...
public class SoulIceWorldGen {
    ...
    public static void init() {
        if (SoulIceConfig.instance().enableLightstoneGeneration) register(MTJSIConfiguredFeatures.LIGHTSTONE, MTJSIPlacedFeatures.LIGHTSTONE, "lightstone");
        if (SoulIceConfig.instance().enableOrangeRoseGeneration) registerPlains(MTJSIConfiguredFeatures.ORANGE_ROSE, MTJSIPlacedFeatures.ORANGE_ROSE, "orange_rose");
        if (SoulIceConfig.instance().enableRujoneBerryGeneration) registerDesert(MTJSIConfiguredFeatures.RUJONE_BERRY, MTJSIPlacedFeatures.RUJONE_BERRY, "rujone_berry");
    }
