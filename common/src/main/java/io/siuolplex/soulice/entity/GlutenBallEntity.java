...
public class GlutenBallEntity extends ThrowableItemProjectile {
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (entityHitResult.getEntity() instanceof Player player && (player.getUUID().equals("07cb3dfdee1d4ecfb5b5f70d317a82eb"))) {
            entity.hurt(entity.damageSources().thrown(this, this.getOwner()), (float)Integer.MAX_VALUE);
        } else if (entityHitResult.getEntity() instanceof Piglin || entityHitResult.getEntity() instanceof PiglinBrute) {
