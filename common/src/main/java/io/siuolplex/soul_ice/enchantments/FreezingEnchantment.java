...
public class FreezingEnchantment extends Enchantment {
    public boolean enabled = ConfigSyncer.isFreezingEnabled;

    public FreezingEnchantment() {
        super(Rarity.UNCOMMON, (ConfigSyncer.isFreezingEnabled) ? EnchantmentTarget.WEAPON : null, new EquipmentSlot[] {EquipmentSlot.MAINHAND});
    }
