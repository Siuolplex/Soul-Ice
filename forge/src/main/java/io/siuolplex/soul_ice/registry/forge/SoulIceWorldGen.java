...
public class SoulIceWorldGen {
    public class MTJSIConfiguredFeatures {
        public static final Holder<ConfiguredFeature<?, ?>> LIGHTSTONE = Holder.createDirect(new ConfiguredFeature<>(Feature.ORE, new OreFeatureConfig(OreConfiguredFeatures.DEEPSLATE_ORE_REPLACEABLES, SoulIceBlocks.LIGHTSTONE.getDefaultState(), 48)));
